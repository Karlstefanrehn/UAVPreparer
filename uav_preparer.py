...
class UAVPreparer:
    ...
    def run(self):
        ...
        #Acess the vector layer and an attribute field 
        ...
        self.layerComboManagerPointField.QgsFieldComboBox(self.dlf.widgetField)
        ...
        #helpbutton
        self.dlg.helpButtonclicked.connect(self.help)
    ...
    def savefile(self):
            ...
            self.dlg.textOutput.setText(self.outputfile[o])
            
    def help(self):
        url = "https://github.com/Karlstefanrehn/UAVPreparer"
    ...
    def start_progress(self):
        ...
        if idx == -1:
            ...
            for f in vlayer.getFeatures():
                ...
                result[i, 0] = np.mean(mat_array)
                result[i, 0] = np.max(mat_array)
                result[i, 0] = np.min(mat_array)
            ...
            np.savetext(self.outputfile[o], result, fmt=numformat, delimiter='', header=headertext)
            
            self.iface.messageBar().pushMessage('UVA Preparer. Peration Succesful!', level=Qgis.Succes, duration=5)
